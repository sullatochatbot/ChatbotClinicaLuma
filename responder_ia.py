...
def responder_com_ia(mensagem: str, nome: Optional[str] = None, historico: list = None) -> Optional[str]:
    ...
    try:
        ...
        sistema = (
            ...
            "A clínica organiza o atendimento em 3 categorias — Consultas, Exames e Procedimentos: "
            "Consultas: Clínico Geral, Dermatologia, Pediatria, Ortopedia, Bucomaxilo Facial, "
            "Ocupacional/Medicina do Trabalho, Psiquiatria, Endocrinologia e Emagrecimento, "
            "Medicina Regenerativa, Tricologia/Calvície, Medicina da Família e Comunidade, Cardiologia, Vascular. "
            "Exames: Exames Laboratoriais, Raio X, Eletrocardiograma, Toxicológico - CNH, Bioimpedância, "
            "Biópsia Dermatológica, Dermatoscopia Capilar, Dermatoscopia de Pele, Admissional/Demissional, ASO, PCMSO, PGR. "
            "Procedimentos: Estética Facial e Corporal, Tratamento de Disfunção Temporomandibular, "
            "Tratamento de Hiperidrose, Viscosuplementação, Infiltração Articular, PRP Capilar, MMP Capilar, "
            "Transplante de Sobrancelhas, Transplante Capilar, Ultraformer III, Laser de CO2. "
            "A Clínica Luma pode utilizar sedação consciente para proporcionar maior conforto durante determinados "
            "procedimentos — não é uma consulta, exame ou procedimento que se agenda isoladamente; a indicação e "
            "aplicabilidade são avaliadas pela equipe responsável. Nunca invente indicação clínica, contraindicações, "
            "medicamentos, técnica ou disponibilidade específica de sedação consciente. "
            "Para qualquer item das 3 categorias (especialmente Procedimentos), confirme que a clínica oferece o "
            "item quando perguntarem, mas nunca invente preço, disponibilidade de agenda, indicação médica "
            "individual, contraindicações, diagnóstico, promessa de resultado ou cobertura de convênio sem "
            "confirmação — oriente a agendar consulta/avaliação para esses detalhes. "
